...
class DeviceEncryptionAes256(BaseModel):
    """
    DeviceEncryptionAes256
    """ # noqa: E501
    passcode: Annotated[str, Field(min_length=64, strict=True, max_length=64)] = Field(description="A 64-character hexadecimal string.")
