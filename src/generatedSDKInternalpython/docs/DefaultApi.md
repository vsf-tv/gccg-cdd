# internal_api_client.DefaultApi
...
with internal_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internal_api_client.DefaultApi(api_client)
    authenticate_request_content = internal_api_client.AuthenticateRequestContent() # AuthenticateRequestContent | 
...
with internal_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internal_api_client.DefaultApi(api_client)
    deprovision_device_request_content = internal_api_client.DeprovisionDeviceRequestContent() # DeprovisionDeviceRequestContent |  (optional)
...
with internal_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internal_api_client.DefaultApi(api_client)
    pair_request_content = internal_api_client.PairRequestContent() # PairRequestContent | 
...
with internal_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internal_api_client.DefaultApi(api_client)
    request_log_request_content = internal_api_client.RequestLogRequestContent() # RequestLogRequestContent |  (optional)
...
with internal_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internal_api_client.DefaultApi(api_client)
    request_thumbnail_request_content = internal_api_client.RequestThumbnailRequestContent() # RequestThumbnailRequestContent | 
...
with internal_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = internal_api_client.DefaultApi(api_client)
    rotate_certificates_request_content = internal_api_client.RotateCertificatesRequestContent() # RotateCertificatesRequestContent | 
