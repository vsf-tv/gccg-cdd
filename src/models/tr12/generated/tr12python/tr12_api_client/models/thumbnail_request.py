...
class ThumbnailRequest(BaseModel):
    ...
    max_size_kilobyte: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxSizeKilobyte")
    ...
    __properties: ClassVar[List[str]] = ["period", "expires", "maxSizeKilobyte", "localPath", "remotePath"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxSizeKilobyte": obj.get("maxSizeKilobyte"),
