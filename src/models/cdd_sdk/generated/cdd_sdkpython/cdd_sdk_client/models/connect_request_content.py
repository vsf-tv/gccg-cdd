...
class ConnectRequestContent(BaseModel):
    """
    ConnectRequestContent
    """ # noqa: E501
    registration: DeviceRegistration
    host_id: StrictStr = Field(alias="hostId")
    __properties: ClassVar[List[str]] = ["registration", "hostId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "registration": DeviceRegistration.from_dict(obj["registration"]) if obj.get("registration") is not None else None,
