...
class DeviceStatus(BaseModel):
    ...
    channels: Optional[List[ChannelStatus]] = None
    __properties: ClassVar[List[str]] = ["status", "channels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": [StatusValue.from_dict(_item) for _item in obj["status"]] if obj.get("status") is not None else None,
            "channels": [ChannelStatus.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None
        })
        return _obj
