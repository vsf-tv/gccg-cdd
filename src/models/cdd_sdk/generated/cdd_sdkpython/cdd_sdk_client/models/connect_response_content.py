...
class ConnectResponseContent(BaseModel):
    """
    ...
    pairing_code: Optional[StrictStr] = Field(default=None, alias="pairingCode")
    expires: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["success", "state", "message", "error", "deviceId", "region", "pairingCode", "expires"]
