...
class DeviceRegistration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["channels", "simpleSettings", "thumbnails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thumbnails": [Thumbnail.from_dict(_item) for _item in obj["thumbnails"]] if obj.get("thumbnails") is not None else None
        })
        return _obj
