...
class ChannelConfiguration(BaseModel):
    ...
    id: StrictStr
    state: ChannelState
    settings: Optional[SettingsChoice] = None
    connection: Optional[Connection] = None
    health: Optional[Health] = None
    __properties: ClassVar[List[str]] = ["id", "state", "settings", "connection", "health"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "state": obj.get("state"),
            "settings": SettingsChoice.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
