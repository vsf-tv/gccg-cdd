...
class Connection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["transportProtocol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transportProtocol": TransportProtocol.from_dict(obj["transportProtocol"]) if obj.get("transportProtocol") is not None else None
        })
        return _obj
